				...
				<div className="flex items-center justify-center h-16">
					...
					{/* <div className="hidden md:block">
						<div className="ml-10 flex items-baseline space-x-8">
							<a
								href="#home"
								className="font-semibold hover:text-orange-400 transition-colors hover:scale-110"
							>
								Home
							</a>
							<a
			...
			{/* {isOpen && (
				<div className="md:hidden border-t-4 border-gray-950">
					<div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-900">
						<a
							href="#home"
							className="block px-3 py-2 font-semibold hover:text-orange-400 transition-colors"
						>
							Home
						</a>
						<a
