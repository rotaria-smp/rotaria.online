		...
		>
			...
			<div className="parallax-content relative z-10 flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 h-full">
				<div className="text-center max-w-4xl mx-auto">
					...
					>
						A relaxed Create-centered modded survival world—welcoming players
						new to the mod scene and seasoned veterans. Automate, build
						infrastructure, trade, and shape each season.
					</p>
